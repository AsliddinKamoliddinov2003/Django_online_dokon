...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CartItemTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('color', models.CharField(max_length=255, null=True)),
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translation', to='shopping.cartitem')),
            ],
            options={
                'verbose_name': 'cart item Translation',
                'db_table': 'shopping_cartitem_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
